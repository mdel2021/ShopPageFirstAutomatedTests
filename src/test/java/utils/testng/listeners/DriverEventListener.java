...
public class DriverEventListener implements WebDriverListener {
    ...
    public void afterFindElements(WebDriver driver, By locator, List<WebElement> result) {
        ...
        System.out.println("Found WebElement list with locator " + locator.toString());
    }

    @Override
    public void beforeClick(WebElement element) {
        WebDriverListener.super.beforeClick(element);
        System.out.println("Trying to click WebElement " + element);
    }

    @Override
    public void afterClick(WebElement element) {
        WebDriverListener.super.afterClick(element);
        System.out.println("Clicked WebElement " + element);
    }
    ...
    public void beforeClear(WebElement element) {
        ...
        System.out.println("Trying to clear WebElement " + element);
    }
    ...
    public void beforeFindElements(WebElement element, By locator) {
        ...
        System.out.println("Trying to find WebElements list with locator " + locator.toString());
    }
